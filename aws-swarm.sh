...
docker-machine create -d amazonec2 --amazonec2-region us-west-2 --amazonec2-zone a aws-manager1
docker-machine create -d amazonec2 --amazonec2-region us-west-2 --amazonec2-zone a aws-app1
docker-machine create -d amazonec2 --amazonec2-region us-west-2 --amazonec2-zone a aws-app2
